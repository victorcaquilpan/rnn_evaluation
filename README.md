...
| ----- | --------- |-----|-------------|--------------|          
|RNN    | **Base model**              |    ---          |     ---          |<img src="[https://your-image-url.type](https://github.com/victorcaquilpan/rnn_evaluation/blob/main/images/mean_gradient_rnn_simple.PNG)" width="100" height="100">|
